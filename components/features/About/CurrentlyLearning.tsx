...
export function CurrentlyLearning() {
  return (
    <Section>
      <div className="border-y-1 border-slate-300 p-15">
        <div className="container flex w-full items-center justify-center rounded-2xl border bg-gray-100 p-5 md:p-10 dark:bg-card">
          <div>
