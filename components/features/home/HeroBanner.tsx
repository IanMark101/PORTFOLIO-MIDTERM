...
export function HeroBanner() {
  return (
    <div className="container mx-auto mt-20 flex items-center justify-center rounded-2xl border-y bg-gray-100 dark:bg-card">
      <div className="flex flex-col-reverse items-center gap-10 p-10 lg:flex-row lg:p-20">
        <div className="flex flex-1 flex-col items-center lg:items-start">
          ...
          <p className="text-sm hover:text-muted-foreground/99">
            ...
            innovative projects and continuously enhance my development skills.
            Skilled in both front-end and back-end technologies, with a strong
            foundation in HTML, CSS, JavaScript, and modern frameworks.
            Committed to writing clean, efficient code and staying updated with
            emerging web development trends to deliver seamless digital
            experiences.
          </p>
        ...
        <div className="relative flex justify-center">
          <div className="relative w-full max-w-[280px] lg:max-w-[450px]">
            <Image
              ...
              width={500}
              height={500}
              className="ml-0 rotate-2 cursor-pointer rounded-lg ring-3 ring-blue-600 transition-transform hover:scale-105 hover:rotate-0 lg:ml-10"
            />
